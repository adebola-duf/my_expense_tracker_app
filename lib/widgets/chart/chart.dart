...
import 'package:my_expense_tracker_app/widgets/chart/chart_bar.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseBucket> get buckets {
    return [
      ...
      ExpenseBucket.forCategory(allExpenses: expenses, category: Category.flex),
            ...
            child: Row(
              ...
              children: [
                for (final bucket in buckets) // alternative to map()
                  ChartBar(
                    fill: bucket.totalExpenses / totalExpense,
                  )
              ],
            ),
          ),
